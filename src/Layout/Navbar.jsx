...
return (
    <div>
            ...
            <ul className={isClicked ? 'lg:hidden flex flex-col gap-5 bg-black text-white p-5 text-center' : "hidden"}>
                                            <Link to='/' onClick={() => setIsClicked(false)}><li className='cursor-pointer'>HOME</li></Link>
                                         ...
                                         <Link to='/movie' onClick={() => setIsClicked(false)}> <li className='cursor-pointer'>MOVIES</li></Link>
                                            <Link to='/series' onClick={() => setIsClicked(false)}><li className='cursor-pointer'>TV SERIES</li></Link>
                                            <Link to='/trending' onClick={() => setIsClicked(false)}><li className='cursor-pointer'>NEWS & POPULAR</li></Link>
                                    </ul>
    </div>
)
}
